...
---
# 2020-08-05 Hypha Worker Co-op: Governance & Operations
...
- coming back from stuff, catch up there
...
- AGM/wrap-up stuff bl needs for Hema:
    ...
    - completed books
    - full names, address, date of birth, phone number their position on the board and date elected (revised to August 10)
    - meeting minutes including the AGM (revised to August 10)
...
- #todo
    - dc: merge board
    - bl: review el's PR
    - dc: set up signing process for new resolution
    - dc: meeting minutes to AGM
