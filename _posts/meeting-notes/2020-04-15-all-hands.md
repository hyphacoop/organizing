...
- StART 
    ...
    - dc: worked with bl for job description, good feedback from uv bl
    - link: https://docs.google.com/document/d/1B17LZ33KkISTfvQEi9SoryVqR4e5ORt-SEgyxSKtWgY/edit#
    - questions:
        - gi who are you contacting with?
            - dc: with Gabe and he want to step away from it a bit
        - uv: how long of the delay with Code Canada
            - Gabe understand and knows pc well
            - 8 weeks for pc to return is too long
        - bl: to start reaching out to other networks
- Qm 
