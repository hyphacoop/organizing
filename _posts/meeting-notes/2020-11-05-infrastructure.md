# 2020-11-05 Hypha Worker Co-op: Infrastructure
...
- yj: meetcoop repo for provisioning keys
    - ansible script that pushes SSH keys and password to proxmox / bbb server
- el: PR for loomio stuff
    - bl: I deleted the droplet
...
- we closed a lot of things and it feels great
