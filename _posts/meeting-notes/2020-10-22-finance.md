...
---
# 2020-10-22 Hypha Worker Co-op: Finance
...
- Open Collective
    - bl: end of month
- Meet.coop
    - invoice hours in GBP (or CAD)
    - invoice all servers in CAD via QB receipt
- Toronto Mesh
    - talk about OC
- COMPOST
    - discussed processes for billing Operations and Profession Fees accounts
- Quickbooks
