...
---
# 2020-08-13 Hypha Worker Co-op: Infrastructure
...
- Review DONE tasks :tada:
	- closed shortlinks task
- Review [`[priority-★★★]`][l-pri-hi] [`[priority-★★☆]`][l-pri-md] [`[priority-★☆☆]`][l-pri-lo] [`[priority-none]`][l-pri-none]
	- discussed several items around ansibles and VMs

### Discussions

- [Meet.coop brand survey](https://forum.meet.coop/t/brand-survey-what-is-meet-coop-to-you/267/3)
    - Functional:
