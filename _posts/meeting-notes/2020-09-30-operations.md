...
---
# 2020-09-30 Hypha Worker Co-op: Governance & Operations
...
- Reviewed and updated OKR sheet, is "honest," though we did very little
  - https://link.hypha.coop/okrs

Can work on and wrap up immediately
- Gov.O1.KR2 Complete AGM wrap up			
- Gov.O3.KR1 Draft statement emphasizing individual accountability adopted at all-hands	
- Ops.O4.KR1 Document initial thoughts on hiring process			
Important but more work:
- Ops.02.KR1 Develop a map of skill gaps (core competencies) across organization

Important but don't have skills/member time:
- Ops.O1.KR2 Update tags and tasks in clockify and document guide for members
- the rest
...
- [`wg:ops`][l-ops] label review
        - kicked time-tracking role as `wont-do`
        - should have process to remove stalled items from board, very longterm items

### Discussions

- briefly discussed time-tracking role 
...
- was interrupted for urgent bizdev call
