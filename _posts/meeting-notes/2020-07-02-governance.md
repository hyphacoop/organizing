...
---
# 2020-07-02 Hypha Worker Co-op: Governance & Operations
...
- bl: beach trip!
    - dc: ontario status of beaches a little confusing
- george floyd and protest
- masking in Canada

### Co-work

Final review section on Bylaws: https://docs.google.com/document/d/1QN8QzmSnnj1GoxybuuFqJoquUtqUEPdX4PRPfchWQFg/edit#heading=h.1xgf2gain4ym
...
- [`wg:gov`][l-gov] label review
    ...
    - #102 AGM. dc sent notice and started drafting agenda and package
        ...
        - bl: chairing?
            - identify chairs: uv, bl
            - yj needs to chair the board of directors
...
- on the 10th, 1 hour co-work on handbook to close off a bunch of ops stuff
    - tagged as `cowork`
