...
---
# 2020-07-16 Hypha Worker Co-op: Finance
...
- Stripe authorization (switch to bl as business rep)
...
- co-work in QB
- now with TransferWise integrations
- Wagepoint integrations after FY1
- can create unpaid invoices and match
- manually match existing Aether invoice and create new USD client for future invoices
- books almost ready for Rodica
