...
tags: Hypha
---
# 2021-04-01 Hypha Worker Co-op: Operations & Governance

<sup>[from template][template] | [:notebook: Meetings][meetings] | [:date: Calendar][calendar] | [:white_check_mark: Tasks][tasks] | [:cat: Code][gh] | [:open_file_folder: Drive][drive]</sup>

Time:       14:00-15:00pm ET  
...
- dc: accidently planning a panel
- pc: got nice vibes and call outs from OC
...
- Did some quick cowork:
    - OC proposal: https://hackmd.io/Kooq3QUcR0CJ2r83OHhemQ
    - CMC initiative stat: https://hackmd.io/WxHHMw7LRwmxNhGKaSWR3Q?both
- Scheduled time for April OC co-work
- Hypha <> Nomadic pay rate sync
    - notes for chat: [private]
    - #todo:pc archive private
    - #todo:dc get this in writing before contract with NL (after C4C contract) 
- Representing Hypha on CWCF JEDI committee (pc)
    - doesn't mention TRC or treaty obligations.
    - #todo:dc email back
    - #todo:pc maybe observer mode first
- Historic rates. [ref](https://github.com/hyphacoop/organizing-private/pull/124#issuecomment-805511662)
    - we both agree about not right place, but want historic rates, not urgent
- Contributing $$$ to hackmd
    - parked, yes!
- Operations:
    - Budget Requests for Strategic Planning meeting
