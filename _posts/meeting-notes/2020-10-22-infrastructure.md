...
---
# 2020-10-22 Hypha Worker Co-op: Infrastructure
...
- Meet.coop - how do we feel. overall 👍

### Announcements

- Loomio Migrated
    - Shut down and confirm all notes are good
    - If we need to we can shut it back up
    - Upgraded
- Garry will start joining in Dec/Jan
- OVH - the server that keep on giving.
    - turn
    - exit node
