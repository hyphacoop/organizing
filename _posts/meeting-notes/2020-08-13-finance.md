...
---
# 2020-08-13 Hypha Worker Co-op: Finance
...
- Review [`[priority-★★★]`][l-pri-hi] [`[priority-★★☆]`][l-pri-md] [`[priority-★☆☆]`][l-pri-lo] [`[priority-none]`][l-pri-none]
	- OC next. donations only

### Discussions

- sensitive tax docs
    - yj: encrypted PDF in Dropbox, with a password we give her, we archive it in the Google Drive
- yj move to another bizdev WG?
    - yj to join bizdev meeting to see how things go
    - bl: maybe garry in infra. yj: that works
    - yj in finance until someone else takes the role
- wagepoint <> qb integration
    - ping Rodica
